...
const EmployeeCard: React.FC<EmployeeCardProps> = ({
  ...
  console.log('Открыт сотрудник:', employee);
            ...
            <>
              ...
              <div className="space-y-3 text-sm text-gray-600">
                ...
                <div>
                  ...
                  {employee.email || <span className="text-gray-400">нет email</span>}
                </div>
                <div>
                  <Phone className="h-4 w-4 inline-block mr-2" />
                  {employee.phone || <span className="text-gray-400">нет телефона</span>}
                </div>
                <div>
                  <Calendar className="h-4 w-4 inline-block mr-2" />
                  {employee.startDate || <span className="text-gray-400">не указана дата</span>}
                </div>
                <div>
